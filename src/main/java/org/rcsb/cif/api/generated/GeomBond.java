...
public class GeomBond extends BaseCategory {
    public GeomBond(String name, Map<String, Column> columns) {
        super(name, columns);
    }

    public GeomBond(String name, int rowCount, Object[] encodedColumns) {
    ...
    public IntColumn getValence() {
        return (IntColumn) (isText ? textFields.computeIfAbsent("valence", IntColumn::new) :
                getBinaryColumn("valence"));
    }
