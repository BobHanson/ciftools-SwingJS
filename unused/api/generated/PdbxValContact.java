...
public class PdbxValContact extends BaseCategory {
    public PdbxValContact(String name, Map<String, Column> columns) {
        super(name, columns);
    }

    public PdbxValContact(String name, int rowCount, Object[] encodedColumns) {
        super(name, rowCount, encodedColumns);
    }

    public PdbxValContact(String name) {
        super(name);
    }
