...
public class IhmGaussianObjEnsemble extends BaseCategory {
    public IhmGaussianObjEnsemble(String name, Map<String, Column> columns) {
        super(name, columns);
    }

    public IhmGaussianObjEnsemble(String name, int rowCount, Object[] encodedColumns) {
        super(name, rowCount, encodedColumns);
    }

    public IhmGaussianObjEnsemble(String name) {
        super(name);
    }
