...
public class CifIOGeneric {
     ...
     */
    public static CifFileGeneric readById(String pdbId) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readById(String pdbId, CifOptions options) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromURL(URL url) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromURL(URL url, CifOptions options) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromPath(Path path) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromPath(Path path, CifOptions options) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromInputStream(InputStream inputStream) throws IOException {
     ...
     * @throws IOException thrown when reading fails
     */
    public static CifFileGeneric readFromInputStream(InputStream inputStream, CifOptions options) throws IOException {
    ...
    private static CifFileGeneric readFromInputStreamWithSpecifiedFileFormat(InputStream inputStream,
                                                                      CifOptions options,
        ...
        if (fileFormat == CifOptions.CifOptionsBuilder.FileFormat.BCIF_GZIPPED || fileFormat == CifOptions.CifOptionsBuilder.FileFormat.BCIF_PLAIN) {
            return new BinaryCifReaderGeneric(options).read(inputStream);
        } else {
            return new TextCifReaderGeneric(options).read(inputStream);
        }
    }

    private static CifFileGeneric readFromInputStreamByGuessingFileFormat(InputStream inputStream, CifOptions options) throws IOException {
